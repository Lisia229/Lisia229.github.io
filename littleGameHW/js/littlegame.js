...
function addDot() {
  ...
  // console.log($("#deku2").offset().left + $("#deku2").innerWidth())
  console.log($(".peoples").first().offset().top)
  console.log($("#deku2").offset().top)
  // console.log($("#deku2").offset().left)
  // console.log($(".peoples").first().offset().left)
  // console.log($("#deku2").offset().top)
}
